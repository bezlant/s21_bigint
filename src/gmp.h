...
#if __SCO_VERSION__ > 400000000 && __STDC__ != 1 && !defined(__GMP_EXTERN_INLINE)
...
#if defined(__SUNPRO_C) && __SUNPRO_C >= 0x560 && !defined(__GMP_EXTERN_INLINE)
#define __GMP_EXTERN_INLINE inline
#endif

/* Somewhat older Sun C compilers want "static inline" */
#if defined(__SUNPRO_C) && __SUNPRO_C >= 0x540 && !defined(__GMP_EXTERN_INLINE)
#define __GMP_EXTERN_INLINE static inline
#endif
...
__GMP_EXTERN_INLINE
#endif
int mpz_fits_uint_p(mpz_srcptr __gmp_z) __GMP_NOTHROW {
...
__GMP_EXTERN_INLINE
#endif
int mpz_fits_ulong_p(mpz_srcptr __gmp_z) __GMP_NOTHROW {
...
__GMP_EXTERN_INLINE
#endif
int mpz_fits_ushort_p(mpz_srcptr __gmp_z) __GMP_NOTHROW {
...
__GMP_EXTERN_INLINE
#endif
int mpn_zero_p(mp_srcptr __gmp_p, mp_size_t __gmp_n) __GMP_NOTHROW {
